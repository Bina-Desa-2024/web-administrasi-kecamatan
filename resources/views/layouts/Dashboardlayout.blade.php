...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('dist/assets/vendors/ti-icons/css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/assets/js/select.dataTables.min.css') }}">
  ...
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{ url('/img/logo-jombang1.png') }}" alt="Logo"></a>
    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ url('/img/logo-jombang1.png') }}" alt="logo" /></a>
  </div>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="/PermintaanSurat">Permintaan Surat</a></li>
          <li class="nav-item"> <a class="nav-link" href="/SuratSelesai">Surat Selesai</a></li>
        </ul>
      </div>
    </li>
  </ul>
  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    ...
    <!-- <script src="{{ asset('dist/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.js') }}"></script> -->
