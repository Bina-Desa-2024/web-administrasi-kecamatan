...
<div class="row mt-4 justify-content-center">
    @forelse ($gallery as $item)
        <div class="col-lg-4 col-md-6 mb-3 img-scale-up">
            ...
            {{-- <img src="{{ asset('storage/app/public/'.$item->gallery) }}" alt="no-image" class="card-img-top "> --}}
                ...
                <form action="{{ route("gallery.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-center">
                            ...
                            <input accept="image/*" onchange="uploadImage(this)" type="file" name="gallery" class="images" >
